...
public class LogoutTest {
    public static void main(String[] args) {
        ...
        By accountbuttonlink =  By.xpath("//*[@id=\"adjustContent\"]/nav/div/div/div/div[2]/ul/li[2]/a");
        By logoutbuttonlink =  By.xpath("//*[@id=\"adjustContent\"]/nav/div/div/div/div[2]/ul/li[2]/ul/li[4]/a");
        try {
            ...
            driver.findElement(passwordfield).sendKeys("01815021306");
            driver.findElement(longinButton2).click();
            driver.findElement(accountbuttonlink).click();
            driver.findElement(logoutbuttonlink).click();
